<form method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input type="date" name="start_date" class="form-control" id="inputStartDate" value="<?php echo $objEvent->getStart_date_form() ?>">
	</div>

    <div class="form-group">
		<label for="inputEndDate">Date de fin :</label>
		<input type="date" name="end_date" class="form-control" id="inputEndDate" value="<?php echo $objEvent->getEnd_date_form() ?>">
	</div>
	...
	<div class="form-group">
		...
		<textarea name="content" class="form-control" id="inputContent"><?php echo $objEvent->getContent() ?></textarea>
	</div>
