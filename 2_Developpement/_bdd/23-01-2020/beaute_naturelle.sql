...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 23 jan. 2020 à 13:37
...
INSERT INTO `slide` (`slide_id`, `slide_libelle`, `slide_img`, `slide_type`, `slide_title`, `slide_text`) VALUES
(2, 'slide 1', 'slide-1.jpg', 'h1', 'Qualités<wb> & Conseils', 'Depuis 10 ans'),
(3, 'slide 2', 'slide-2.jpg', 'h1', 'Le Choix', 'Plus de 50 références bio'),
(4, 'slide 3', 'slide-3.jpg', 'h2', '“Sous le maquillage et derrière le sourire, je ne suis qu\'une fille qui souhaite le monde.\"', '- Marilyn Monroe');
