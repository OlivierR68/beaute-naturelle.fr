<main class="container bn_content">
	...
	<p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il
		est précisé aux utilisateurs du site <a
			href="{site_url()}">https://beaute-naturelle.fr</a> l'identité des différents
	...
	<p>L’utilisation du site <a href="{site_url()}">https://beaute-naturelle.fr</a>
		implique
		...
		<a href="{site_url()}">https://beaute-naturelle.fr</a> sont donc invités à les
	...
	<p>Le site <a href="{site_url()}">https://beaute-naturelle.fr</a> est mis à jour
	...
	<p>Le site <a href="{site_url()}">https://beaute-naturelle.fr</a> a pour objet de
		fournir
		une information concernant l’ensemble des activités de la société.</p>
	<p>BEAUTE NATURELLE s’efforce de fournir sur le site <a
			href="{site_url()}">https://beaute-naturelle.fr</a> des informations aussi
	...
	<p>Tous les informations indiquées sur le site <a
			href="{site_url()}">https://beaute-naturelle.fr</a> sont données à titre
		indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le site <a
			href="{site_url()}">https://beaute-naturelle.fr</a> ne sont pas exhaustifs.
		Ils
	...
	<p>BEAUTE NATURELLE ne pourra également être tenue responsable des dommages indirects (tels par exemple
		...
		perte de marché ou perte d’une chance) consécutifs à l’utilisation du site <a
			href="{site_url()}">https://beaute-naturelle.fr</a>.</p>
	...
	<p>A l'occasion de l'utilisation du site <a
			href="{site_url()}">https://beaute-naturelle.fr</a>, peuvent êtres
		recueillies :
		l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au site <a
			href="{site_url()}">https://beaute-naturelle.fr</a>, le fournisseur d'accès
		de
	...
	<p> En tout état de cause BEAUTE NATURELLE ne collecte des informations personnelles relatives à
		...
		que pour le besoin de certains services proposés par le site <a
			href="{site_url()}">https://beaute-naturelle.fr</a>. L'utilisateur fournit
		ces
		...
		alors précisé à l'utilisateur du site <a
			href="{site_url()}">https://beaute-naturelle.fr</a> l’obligation ou non de
	...
	<p>Aucune information personnelle de l'utilisateur du site <a
			href="{site_url()}">https://beaute-naturelle.fr</a> n'est publiée à l'insu de
	...
	<p>Le site <a href="{site_url()}">https://beaute-naturelle.fr</a> contient un certain
	...
	<p>La navigation sur le site <a href="{site_url()}">https://beaute-naturelle.fr</a>
		est
	...
	<p>Tout litige en relation avec l’utilisation du site <a
			href="{site_url()}">https://beaute-naturelle.fr</a> est soumis au droit
		français.
