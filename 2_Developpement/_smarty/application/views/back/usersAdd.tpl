<form method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-12 col-sm-6 col-md-4">
            <div class="form-group">
                ...
                <div class="custom-file">
                    <input type="file" name="avatar" class="form-control-file " accept="image/png, image/jpeg"
                           id="inputAvatar">
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4">
            ...
            <div class="form-group">
                ...
                <input type="text" name="last_name" class="form-control" id="inputLast_name"
                       value="{$objUser->getLast_name()}">
            </div>

            <div class="form-group">
                <label for="inputFirst_name">Prénom :</label>
                <input type="text" name="first_name" class="form-control" id="inputFirst_name"
                       value="{$objUser->getFirst_name()}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" class="form-control" id="inputEmail" value="{$objUser->getEmail()}"
                       autocomplete="off">
            </div>
        ...
        <div class="col-12 col-sm-6 col-md-4">
            ...
            <div class="form-group">
                ...
                <input type="number" name="age" max="100" min="18" class="form-control" id="inputAge"
                       value="{$objUser->getAge()}">
            </div>
    ...
    <a href="{base_url('users/listPage')}" class="btn btn-dark">{$buttonCancel}</a>
</form>
